...
// or with arrays
type FavoriteThings = ["Raindrops on Roses🌹", "Crisp Apple Strudel", "Type Theory"]
let favoriteThings: FavoriteThings = ["Raindrops on Roses🌹", "Crisp Apple Strudel", "Type Theory"]
