...
function getShape(choice: "circle" | "rectangle" | "triangle", value: number): Circle | Rectangle | Triangle {
    switch (choice) {
        case "circle": return new Circle(value);
        case "rectangle": return new Rectangle(value, value);
        case "triangle": return new Triangle(value, value);
    }
}
