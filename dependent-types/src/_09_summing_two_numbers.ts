 ...
 * ## General Purpose
 * 
 * So far it has probably seemed like parlor tricks incapable of generalizing. 😃
 * Skip to the bottom. 👇
 */
module ReadMe {}
...
type SumResultWithDigits = SumAPI.Sum<3, 356>
type SumResultWithStrings = SumAPI.Sum<"41", "616">
